...
def load_to_snowflake(**kwargs):
    ...
    insert_query = """
    INSERT INTO FINANCIAL_ENTITY_ANNUAL_TIME_SERIES_TRANSFORMED (
        ENTITY_NAME, CITY, STATE_ABBREVIATION, YEAR,
        "Total Assets", "Total Securities", "Total deposits",
        "% Insured (Estimated)", "All Real Estate Loans"
